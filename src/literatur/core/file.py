...
def lit_listpartialupdate_hashsize(list_full, working_path):
	...
	for ii in list_full:
		...
		ii[lit_id_size] = os.path.getsize(os.path.join(working_path, lit_path_subfolder_lit, ii[lit_id_filename]))
...
def lit_get_list(working_path):
	...
	lit_path = os.path.join(working_path, lit_path_subfolder_lit)
